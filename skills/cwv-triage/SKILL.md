---
name: cwv-triage
description: "Identify which pages on a domain need Core Web Vitals (CWV) work and prioritize them by urgency."
---

<!-- Generated from .agents/skills/cwv-triage.md by plugin-sync.js — edit there, then `npm run plugin:sync`. -->
