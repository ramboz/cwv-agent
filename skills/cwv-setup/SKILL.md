---
name: cwv-setup
description: "Prepare or report prerequisites for a selected cwv-agent execution profile without touching site data."
---

<!-- Generated from .agents/skills/cwv-setup.md by plugin-sync.js — edit there, then `npm run plugin:sync`. -->
