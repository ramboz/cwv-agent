---
name: cwv-diagnose
description: "Perform a deep, evidence-based performance diagnosis for a single URL."
---

<!-- Generated from .agents/skills/cwv-diagnose.md by plugin-sync.js — edit there, then `npm run plugin:sync`. -->
