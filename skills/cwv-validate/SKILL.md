---
name: cwv-validate
description: "Statistically validate that a `patches.json` (or a permanently implemented fix) produces a real, significant CWV improvement — not random lab variance."
---

<!-- Generated from .agents/skills/cwv-validate.md by plugin-sync.js — edit there, then `npm run plugin:sync`. -->
