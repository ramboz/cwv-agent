---
name: cwv-fix
description: "Interactively develop and measure a performance fix for a specific URL."
---

<!-- Generated from .agents/skills/cwv-fix.md by plugin-sync.js — edit there, then `npm run plugin:sync`. -->
