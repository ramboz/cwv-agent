---
name: cwv-analyze
description: "Given a URL, run the minimum set of collectors and analyzers needed to produce a prioritized, schema-conformant Finding envelope covering LCP / CLS / INP / FCP / TTFB, with patch candidates ready for `cwv-fix`."
---

<!-- Generated from .agents/skills/cwv-analyze.md by plugin-sync.js — edit there, then `npm run plugin:sync`. -->
